        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/index.php/Admin/Goods/tianjia">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
                ...
                <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr id="product1">
                        ...
                        <td><img src="<?php echo ($const_IMG); ?>20121018-174034-58977.jpg" height="60" width="60"></td>
                        <td><img src="<?php echo ($const_IMG); ?>20121018-174034-97960.jpg" height="40" width="40"></td>
